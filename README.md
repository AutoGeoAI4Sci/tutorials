...
```text
tutorials/
├── foundations/        # Core GIS, Python, spatial data fundamentals
├── spatial-computing/  # Spatial SQL, databases, indexing, systems
├── geoai/              # GeoAI, ML/DL, multimodal spatial intelligence
├── visualization/      # Mapping, dashboards, spatial visualization
...
## 📌 Tutorial Entry Template (For Contributors)
